...
const App: React.FC = () => {
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col bg-gray-50 dark:bg-gray-900 overflow-hidden animate-fade-in transition-colors duration-500">
      ...
      <main className="flex-1 relative h-full">
        ...
        {!state.isNavigating && state.currentView === 'map' && (
            <StationOverlay 
                ...
                onStartNavigation={() => actions.handleStartNavigation(state.selectedStation!)} 
            />
        )}
            ...
            <div className="absolute inset-0 z-[50] bg-gray-50 dark:bg-gray-900 overflow-y-auto animate-fade-in">
                <ReservationsView 
                    ...
                    onStartNavigation={(sid) => {
                         ...
                         if(s) { 
                             actions.setSelectedStation(s); 
                             actions.handleStartNavigation(s); 
                         }
                    }}
